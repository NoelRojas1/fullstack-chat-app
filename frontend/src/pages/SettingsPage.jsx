...
const PREVIEW_MESSAGES = [
    ...
    { id: 2, content: "I'm doing great! Just chilling!", isSent: true},
];
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-8 gap-2">
                    {THEMES.map((t) => (
                        <button
                            key={t.id}
                            className={`group flex flex-col items-center gap-1.5 p-2 rounded-lg transition-colors ${t === theme ? "bg-base-200" : "hover:bg-base-200/50"}`}
                            onClick={() => setTheme(t)}
                        >
                                ...
                                <div className="p-4 border-t border-base-300 bg-base-100">
                                    <div className="flex gap-2">
                                        <input
                                            ...
                                            placeholder="Type yopur message..."
